...
public class UserNotificationToUserNotificationDtoTransformer implements Function<UserNotification, UserNotificationDto> {
    ...
    public UserNotificationDto apply(final UserNotification userNotification) {
        if (userNotification instanceof TeamAddUserNotification) {
            return teamAddUserNotificationToTeamAddUserNotificationDtoTransformer.apply((TeamAddUserNotification)userNotification);
        }
        return null;
    }
