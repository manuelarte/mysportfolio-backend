...
public class RegisteredTeamToTeamInMatchInListDtoTransformer implements
    Function<RegisteredTeam, TeamDto> {
  ...
  public TeamDto apply(final RegisteredTeam registeredTeam) {
    final var team = teamRepository.findById(registeredTeam.getTeamId())
        .orElseThrow(() -> new IllegalArgumentException(
            String.format("The team with id %s not found", registeredTeam.getTeamId())));
