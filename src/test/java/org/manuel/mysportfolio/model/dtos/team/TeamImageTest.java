...
class TeamImageTest {
  ...
  public void testSerializeUrlImage() throws JsonProcessingException {
    final var teamImage = new UrlImageDto("https://localhost:8080");
  ...
  public void testDeserializeUrlImage() throws IOException {
    final UrlImageDto expected = new UrlImageDto("https://localhost:8080");
    final var json = new JSONObject();
    json.put("type", "url");
    json.put("url", expected.getUrl());

    assertEquals(expected, OBJECT_MAPPER.readValue(json.toString(), TeamImageDto.class));
  }
