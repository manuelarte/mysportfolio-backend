...
class TeamKitTest {
  ...
  public void testSerializeKitBasic() throws JsonProcessingException {
    final TeamKit<PlainKitPart, PlainKitPart> teamKit = new TeamKit(new PlainKitPart(123),
        new PlainKitPart(123));
  ...
  public void testDeserializeKitBasic() throws IOException {
    final TeamKit<PlainKitPart, PlainKitPart> expected = new TeamKit(new PlainKitPart(123),
        new PlainKitPart(123));
